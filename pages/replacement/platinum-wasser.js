...
export default function replacementAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу замены картриджей Platinum-wasser"
                      modalType = {7}
                   />
                   : null}
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Замена картриджей Platinum-wasser</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Замена картриджей Platinum-wasser
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/ra1.png" alt=""/>
                      <h2 className="service-title">Замена картриджей Platinum-wasser</h2>
                      ...
                      моделях фильтров марки «Platinum-wasser». Являясь официальным диллером компания предоставляет всем своим клиентам настоящую
