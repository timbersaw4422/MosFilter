...
export default function replacementAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу замены картриджей Аквафор"
                      modalType = {7}
                   />
                   : null}
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Замена картриджей Аквафор</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Замена картриджей Аквафор
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/ra1.png" alt=""/>
                      <h2 className="service-title">Замена картриджей Аквафор</h2>
                      ...
                      моделях фильтров марки «Аквафор». Являясь официальным диллером компания предоставляет всем своим клиентам настоящую
