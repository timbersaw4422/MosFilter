...
export default function replacementAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу замены картриджей Барьер"
                      modalType = {7}
                   />
                   : null}
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Замена картриджей Барьер</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Замена картриджей Барьер
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/ra1.png" alt=""/>
                      <h2 className="service-title">Замена картриджей Барьер</h2>
                      ...
                      моделях фильтров марки «Барьер». Являясь официальным диллером компания предоставляет всем своим клиентам настоящую
                ...
                <div className="service-price-block">
                  <div className="price-block__left">
                      ...
                      <p className="price-block__title with-line-through">1250 <i style = {{fontSize:"15px"}}className="fas fa-ruble-sign"></i></p>
                  </div>
