...
export default function installationtAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу установки фильтра Атолл"
                      modalType = {7}
                   />
                   : null}
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Установка фильтра Atoll
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/man1.png" alt=""/>
                      <h2 className="service-title">Установка фильтра Atoll</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональной установкой фильтров «Atoll». </span>
                  ...
                  <div className="flex-right"><img src="/img/logos/atoll.png" alt=""/></div>
                </div>
