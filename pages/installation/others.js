...
export default function installationtOthers(){

  let links= [
    {id:2, text:"Замена картриджей", link:`/replacement/others`},
    {id:3, text:"Ремонт фильтра", link:`/repair/others`},
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу установки фильтра"
                      modalType = {7}
                   />
                   : null}
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Установка фильтров</title>
            ...
            <div className="content-right">
                ...
                <div className="d-flex">
                  <div className="flex-left">
                      ...
                      <h2 className="service-title">Установка фильтров</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональной установкой
                       фильтров для воды. </span>
