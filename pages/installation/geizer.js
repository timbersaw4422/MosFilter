  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Установка фильтра Гейзер</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Установка фильтра Гейзер
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/man1.png" alt=""/>
                      <h2 className="service-title">Установка фильтра Гейзер</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональной установкой фильтров «Гейзер». </span>
