...
export default function installationtAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу установки фильтра Аквафор"
                      modalType = {7}
                   />
                   : null}
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Установка фильтра Аквафор</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Установка фильтра Аквафор
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/man1.png" alt=""/>
                      <h2 className="service-title">Установка фильтра Аквафор</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональной установкой фильтров «Аквафор». </span>
                  ...
                  <div className="flex-right"><img src="/img/logos/aquaphor.png" alt=""/></div>
                </div>
