  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Ремонт фильтра Platinum-wasser</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Ремонт фильтров Platinum-wasser
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/man2.png" alt=""/>
                      <h2 className="service-title">Ремонт фильтров Platinum-wasser</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональным ремонтом </span> и
                      диагностикой фильтров марки «Platinum-wasser». Являясь официальным диллером компания предоставляет всем своим клиентам
