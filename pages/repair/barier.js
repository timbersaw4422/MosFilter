...
export default function installationtAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу ремонта фильтра Барьер"
                      modalType = {7}
                   />
                   : null}
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Ремонт фильтра Барьер</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Ремонт фильтров Барьер
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/man2.png" alt=""/>
                      <h2 className="service-title">Ремонт фильтров Барьер</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональным ремонтом </span> и
                      диагностикой фильтров марки «Барьер». Являясь официальным диллером компания предоставляет всем своим клиентам
                ...
                <div className="service-price-block">
                  <div className="price-block__left">
                      ...
                      <p className="price-block__title with-line-through">1100 <i style = {{fontSize:"15px"}}className="fas fa-ruble-sign"></i></p>
                  </div>
                  <div className="price-block__right">
                      <p className="price-block__subtitle service-block-widthness">Стоимость услуги у нас</p>
                      <p className="price-block__subtitle">750 <i style = {{fontSize:"21px"}}className="fas fa-ruble-sign"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
