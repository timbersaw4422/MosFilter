...
export default function installationtAtoll(){
  ...
  return(
    ...
    {isModalOpen ? <ModalWithAlertProvider
                      ...
                      title = "Заказать услугу ремонта фильтра Атолл"
                      modalType = {7}
                   />
                   : null}
     ...
     <div className="content-wrapper">
        ...
        <Head>
          <title>Мос - фильтр | Ремонт фильтра Atoll</title>
        ...
        <section className="content-block">
            ...
            <div className="content-right">
                <div className="path2">
                    ...
                    /
                    Ремонт фильтров Atoll
                </div>
                <div className="d-flex">
                  <div className="flex-left">
                      <img src="/img/categories/man2.png" alt=""/>
                      <h2 className="service-title">Ремонт фильтров Atoll</h2>
                      <p className="service-text"><span className="with-bold">Компания «Мос—Фильтр» занимается профессиональным ремонтом </span> и
                      диагностикой фильтров марки «Atoll». Являясь официальным диллером компания предоставляет всем своим клиентам
