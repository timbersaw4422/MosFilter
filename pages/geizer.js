...
export default function Geizer(
  ...
  const stocks = [
    {id:1, subtitle:"Комплект картриджей", title:"Гейзер «Престиж»", oldPrice:3600, newPrice:2990, img:"/img/landing/geizer-stock1.png", discount:"-15%"},
  ...
  return(
    <div className="landing" style={{background:"#F9FAFC"}}>
      <Head>
        <title>Мос - Фильтр | Покупка, замена, установка картриджей для фильтров Гейзер в Москве</title>
