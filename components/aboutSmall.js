const AboutSmall = () => {
  return(
    <div className="about-small">
       <div className="about-small__left">
      ...
      <div className="about-small__right">
         <h2 className="small-about__title">О компании</h2>
         <p className="about-small__text">Компания «Мос - Фильтр» занимается продажей и заменой картриджей для фильтров воды,
             а также их установкой и ремонтом. Мы работаем по данному направлению с 2012 года за время своего
             существования обслужили более 30 000 клиентов во всех районах Москвы и Подмосковья.
             Наша служба и опасна и трудна а пожелай ты им не пуха не пера, прорвёмся ответят опера. <br /> <br />
             Дальше ещё какой-то сео текст про картриджи, про фильтры про честную службу, что бы индексировалось всё красоте
             что было. Вот такая вот рыба тут с мукой. Ну проточный фильтр атолл, мембрана для систем осмоса.
         </p>
