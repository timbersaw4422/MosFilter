...
const AboutSmall = () => {
  ...
  return(
    <div className="about-small" >
       <div className="about-small__left" onClick={clickHandler}>
      ...
      <div className="about-small__right">
         ...
         а также их установкой и ремонтом. Мы работаем по данному направлению с 2012 года за время своего существования
         обслужили более 30 000 клиентов во всех районах Москвы и Подмосковья.
         </p>
