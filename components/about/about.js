  ...
  return(
    ...
    <div className="about">
       <div className="about__left">
           ...
           Работа с людьми дала нам чёткое понимание их потребностей и проблем, которые мы продолжаем решать по сей день. <br/></p>
           ...
           <p className="about__paragraph"><span className="blue">3. </span> Картриджи европейского качества</p>
