const CalculatorChoise = () => {
  return(
    <div className="calculator__choise">
        <p className="choise__title">Выберите марку вашего фильтра</p>
        <div className="choise__input">
          <span className="input__current-value">Atoll</span>
