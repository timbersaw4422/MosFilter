...
import AsideNavSublinks from "./AsideNavSublinks";
import {useState} from "react";

const AsideNavItem = ({text, link, subLinks}) => {

  const [dispalaySubLinks, setDisplaySubLinks] = useState("none");

  const mouseEnterHandler = () => {
    setDisplaySubLinks("flex");
  }
  ...
  return(
      <Link href="/categories/[category]" as={link}>
      <div className="aside-nav__item"
          ...
          <AsideNavSublinks sublinks = {subLinks} dispalaySubLinks = {dispalaySubLinks}/>
