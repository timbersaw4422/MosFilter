  ...
  return(
    <div className="payment">
      <div className="payment-left">
          ...
          <h3 className="payment__title" style={{fontSize:"20px"}}>Способы оплаты:</h3>
          <p className="payment__paragraph with-point">Наличными курьеру </p>
          <p className="payment__paragraph with-point">Картой через банковсий терминал курьеру</p>
          <p className="payment__paragraph with-point">При помощи любых мобильных банковских приложений </p>
          <p className="payment__paragraph with-point">Наложенным платежём при заказе по почте</p>
      ...
      <div className="payment-right" onClick={clickHandler}>
