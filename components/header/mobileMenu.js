    ...
    <>
      <div className="mobile-menu" onScroll={scrollHandler}>
         ...
         <div className="close-menu" onClick = {() => setMenuOpen(false)}>
           ...
           <Link href="/forbusiness"><a className="mobile-menu__link">Для бизнесы</a></Link>
         ...
         <div className="header__phone">
             ...
             <p className="header__phone-title">+7 (495) 744 - 61 - 81</p>
         </div>
         ...
         <p className="mobile-menu__rights">
           ...
           «Мос — фильтр» Магазин фильров для воды.
         </p>
      </div>
